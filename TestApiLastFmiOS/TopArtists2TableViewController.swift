...
class TopArtists2TableViewController: UITableViewController {
...
extension TopArtists2TableViewController : IndicatorInfoProvider {
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "Top artists 2")
    }
}
